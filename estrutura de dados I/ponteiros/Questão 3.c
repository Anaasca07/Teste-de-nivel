...
int *p1; // indicou um ponteiro do tipo inteiro
int *p2 = &a; // declarado um ponteiro do tipo inteiro e esse ponteiro recebe o endereço da variável a
int *p3 = &c; // declarado um ponteiro do tipo inteiro e esse ponteiro recebe o endereço da variavel c
